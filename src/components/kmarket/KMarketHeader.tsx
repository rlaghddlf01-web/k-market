            ...
            <div className="flex items-center gap-2.5 cursor-pointer">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="text-[20px] sm:text-[22px] font-black tracking-tight text-[#1f1914] leading-none">{t('케이마켓')}</span>
                  <span className="text-[9px] font-black bg-[#ede2d6] text-[#5c4a39] px-1.5 py-0.5 rounded-md tracking-wider">FREE</span>
                </div>
                <p className="text-[11px] text-[#8c7866] hidden sm:block mt-0.5 font-medium">{t('외국인 근로자 17개국어 안심 직거래 마켓')}</p>
              </div>
            </div>
